...
namespace FluUrl.Utils
{
    ...
    public static class NLogUtil
    {
        ...
        private static readonly string ConnectionString = AppSettingsHelper.GetContent("ConnectionStrings", "SqlConnection");
        private static readonly string DbTypeString = AppSettingsHelper.GetContent("ConnectionStrings", "DbType");
        ...
        public static void WriteAll(NLog.LogLevel logLevel, LogType logType, string logTitle, string message, Exception exception = null)
        {
            //先存文件
        ...
        /// <param name="message">信息</param>
        /// <param name="exception">异常</param>
        public static void WriteDbLog(NLog.LogLevel logLevel, LogType logType, string logTitle, string message, Exception exception = null)
        {
